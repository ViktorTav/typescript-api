...
describe("Rating service", () => {
    ...
    describe("Get rating based on wind and wave positions", () => {
        //Onshore winds = Vento a favor da onda
        it("should get a rating 1 for a beach with onshore winds", () => {
        ...
        it("should get a rating 3 for a beach with cross winds", () => {
            const rating = defaultRating.getRatingBasedOnWindAndWavePositions(
                GeoPosition.E,
                GeoPosition.S
            );
    ...
    describe("Get rating based on swell period", () => {
        it("should get of rating of 1 for a period of 5 seconds", () => {
            const rating = defaultRating.getRatingForSwellPeriod(5);
            expect(rating).toBe(1);
        });

        it("should get of rating of 2 for a period of 9 seconds", () => {
            const rating = defaultRating.getRatingForSwellPeriod(9);
            expect(rating).toBe(2);
        });

        it("should get of rating of 4 for a period of 12 seconds", () => {
            const rating = defaultRating.getRatingForSwellPeriod(12);
            expect(rating).toBe(4);
        });

        it("should get of rating of 5 for a period of 16 seconds", () => {
    ...
    describe("Get rating based on swell height", () => {
        ...
        it("should get rating 3 for for waist high swell", () => {
